...
public class Ficha extends JDialog {
	...
	public Ficha() {
		...
		txtTecnico.setToolTipText("Técnico");
		...
		lblFoto = new JLabel("");
		lblFoto.setToolTipText("Foto do Equipamento");
		...
		table.setModel(new DefaultTableModel(
				new Object[][] { { ' ', ' ' }, { ' ', ' ' }, { ' ', ' ' }, { ' ', ' ' }, { ' ', ' ' }, { ' ', ' ' },
						{ ' ', ' ' }, { ' ', ' ' }, },
				new String[] { "Orçamento", "Equipamento", "Defeito", "Cliente", "Status" }));
		...
		nomeContato.setOnlyText(true);
		nomeContato.setAcceptSpace(true);
...
// aqui
	...
	private void pesquisarFornecedor() {
		String read3 = "select servico.idOs as Orçamento, equipamento as Equipamento, defeito as Defeito, clientes.nomeContato as Cliente, statusReparo as Status from servico join clientes on servico.idCliente = clientes.idFor where idOs like ?";
		try {
			Connection con = dao.conectar();
