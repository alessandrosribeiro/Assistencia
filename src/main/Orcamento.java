			...
			try {
				...
				while (rs.next()) {
					...
					Paragraph col3 = new Paragraph(
							new Paragraph(rs.getString(3), FontFactory.getFont(FontFactory.HELVETICA, 17F, Font.BOLD)));
					...
					Paragraph col11 = new Paragraph(new Paragraph(rs.getString(11),
							FontFactory.getFont(FontFactory.HELVETICA, 20F, Font.BOLD, BaseColor.GRAY)));
